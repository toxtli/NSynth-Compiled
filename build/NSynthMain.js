...
var _Modernizr = __webpack_require__(335);
...
// module
exports.push([module.i, "body,html{background-color:#1c1c2a;color:#fff;font-family:Quicksand,sans-serif;position:absolute;top:0;left:0;width:100%;height:100%;margin:0;overflow:hidden;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}#teal{background-color:#65bef0}#purple{background-color:#fc5b13}", ""]);
 ...
 * https://modernizr.com/download/?-webaudio-setclasses !*/
!function (n, e, o) {
  function s(n, e) {
    return (typeof n === "undefined" ? "undefined" : _typeof(n)) === e;
  }function a() {
    var n, e, o, a, i, l, r;for (var c in f) {
      if (f.hasOwnProperty(c)) {
        if (n = [], e = f[c], e.name && (n.push(e.name.toLowerCase()), e.options && e.options.aliases && e.options.aliases.length)) for (o = 0; o < e.options.aliases.length; o++) {
    ...
    var e = r.className,
        o = Modernizr._config.classPrefix || "";if (c && (e = e.baseVal), Modernizr._config.enableJSClass) {
      var s = new RegExp("(^|\\s)" + o + "no-js(\\s|$)");e = e.replace(s, "$1" + o + "js$2");
      ...
      f.push({ name: n, fn: e, options: o });
    }, addAsyncTest: function addAsyncTest(n) {
      f.push({ name: null, fn: n });
    } },
      Modernizr = function Modernizr() {};Modernizr.prototype = l, Modernizr = new Modernizr(), Modernizr.addTest("webaudio", function () {
    var e = "webkitAudioContext" in n,
        o = "AudioContext" in n;return Modernizr._config.usePrefixes ? e || o : o;
